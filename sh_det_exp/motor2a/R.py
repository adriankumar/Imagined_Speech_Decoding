...
ds_num = 3 #key 3 is BCICIV2a sample (subject 1, preprocessed)
...
print(f"BCICIV2a dataset | Subject 1 | Preprocessed | Run 1 |")
...
def run_experiment(L, solver_idx=0):
    ...
    bar_path = f"det_exp/motor2a/{L}/solver_{solver_idx}/results_bgraph" #for bar graph
    ...
    recon_path = f"det_exp/motor2a/{L}/solver_{solver_idx}/results_recon" #for electrode recon
