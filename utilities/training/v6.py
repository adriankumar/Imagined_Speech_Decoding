...
def training_V6(model, n_epochs, n_eps, segment_length,
                ...
                critic_grad_clip=7.0, actor_grad_clip=7.0, base_alpha=-2.0, 
    ...
    for epoch in range(n_epochs):
        ...
        print(f"avg reward: {stats['avg_reward']:.4f} | avg policy loss: {stats['avg_policy_loss']:.4f} | avg Q1 loss: {stats['avg_q1_loss']:.4f} | avg Q2 loss: {stats['avg_q2_loss']:.4f} |")
