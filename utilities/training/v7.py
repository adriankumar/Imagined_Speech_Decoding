...
def init_optim_and_schedulers(q1, q2, lr_q, model, lr_policy, adaptive_lr,
    ...
    return policy_params, q1_optim, q2_optim, policy_optim, schedulers
...
def update_actor(model, batcher, q1, q2, 
    ...
    alpha_for_model = get_alpha(learnable_alpha, True, log_alpha)
    ...
    torch.nn.utils.clip_grad_norm_(params, max_norm=grad_clip) #clip policy params
    ...
    return loss_avg.item(), alpha_loss
...
def training_V7(model, n_epochs, n_eps, segment_length,
                ...
                critic_grad_clip=7.0, actor_grad_clip=7.0, base_alpha=-2.0, learnable_alpha=True,
    ...
    if learnable_alpha:
        ...
        log_alpha_optim = torch.optim.Adam([log_alpha], lr=3e-4)
    ...
    for epoch in range(n_epochs):
        ...
        for _ in update_bar:
            ...
            #update policy 
            policy_loss, alpha_loss = update_actor(
        ...
        print(f'avg_r: {stats["avg_reward"]:.4f} | avg_pl: {stats["avg_policy_loss"]:.4f} |'
              f'avg_q1_l: {stats["avg_q1_loss"]:.4f} | avg_q2_l: {stats["avg_q2_loss"]:.4f} |'
              f'avg_a_l: {avg_alpha_loss:.4f} | c_a: {alpha_bellman:.4f}')
