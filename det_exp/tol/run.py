...
ds_num = 2 #key 1 is thinking out loud sample (subject 1, preprocessed)
...
print(f"Thinking Out Loud dataset | Subject 1 | Preprocessed | Run 1 |")
...
montage = "biosemi128" #specified by paper
...
def run_experiment(L, solver_idx=0):
    ...
    bar_path = f"det_exp/tol/{L}/solver_{solver_idx}/results_bgraph" #for bar graph
    ...
    recon_path = f"det_exp/tol/{L}/solver_{solver_idx}/results_recon" #for electrode recon
